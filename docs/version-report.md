...
spatial localization flow on one generated image:
...
This report is intentionally outside CanpGrid Core. It does not perform real
clicks, does not call a model, does not identify UI semantics, and does not
execute tasks. It only visualizes how image-space references become candidate
